...
class WartTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedExceptionMessage Invalid create args for "\Wart\Tests\Fixtures\Baz". Use either array or Callable
     */
    ...
    {
        $wart = new \Wart();
        $wart->register('\Wart\Tests\Fixtures\Foo');
        $wart->register('\Wart\Tests\Fixtures\Bar');
        $this->assertInstanceOf('\Wart\Tests\Fixtures\Foo', $wart['\Wart\Tests\Fixtures\Foo']);
